  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center px-8 py-16">
      ...
      <footer className="mt-14">
        <Link href="/admin" className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-300 text-base transition-colors border border-slate-700 hover:border-slate-500 rounded-lg px-5 py-2.5">
